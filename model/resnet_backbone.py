...
def test_intermediate_output_shapes():
    ...
    x = torch.randn(2, 3, 512, 512)
    y = net(x)
    print(f'ResNet18 C3 output shape = {y[0].shape}')
    assert y[0].shape == torch.Size([2, 128, 64, 64])
    print(f'ResNet18 C4 output shape = {y[1].shape}')
    assert y[1].shape == torch.Size([2, 256, 32, 32])
    print(f'ResNet18 C5 output shape = {y[2].shape}')
    assert y[2].shape == torch.Size([2, 512, 16, 16])

    net = resnet34()
    y = net(x)
    print(f'ResNet34 C3 output shape = {y[0].shape}')
    assert y[0].shape == torch.Size([2, 128, 64, 64])
    print(f'ResNet34 C4 output shape = {y[1].shape}')
    assert y[1].shape == torch.Size([2, 256, 32, 32])
    print(f'ResNet34 C5 output shape = {y[2].shape}')
    assert y[2].shape == torch.Size([2, 512, 16, 16])

    net = resnet50()
    y = net(x)
    print(f'ResNet50 C3 output shape = {y[0].shape}')
    assert y[0].shape == torch.Size([2, 128, 64, 64])
    print(f'ResNet50 C4 output shape = {y[1].shape}')
    assert y[1].shape == torch.Size([2, 256, 32, 32])
    print(f'ResNet50 C5 output shape = {y[2].shape}')
    assert y[2].shape == torch.Size([2, 512, 16, 16])

    net = resnet101()
    y = net(x)
    print(f'ResNet101 C3 output shape = {y[0].shape}')
    assert y[0].shape == torch.Size([2, 128, 64, 64])
    print(f'ResNet101 C4 output shape = {y[1].shape}')
    assert y[1].shape == torch.Size([2, 256, 32, 32])
    print(f'ResNet101 C5 output shape = {y[2].shape}')
    assert y[2].shape == torch.Size([2, 512, 16, 16])

    net = resnet152()
    y = net(x)
    print(f'ResNet152 C3 output shape = {y[0].shape}')
    assert y[0].shape == torch.Size([2, 128, 64, 64])
    print(f'ResNet152 C4 output shape = {y[1].shape}')
    assert y[1].shape == torch.Size([2, 256, 32, 32])
